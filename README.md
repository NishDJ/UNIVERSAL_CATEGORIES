...
[![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/NishDJ/UNIVERSAL_CATEGORIES/markdown-validation.yml?branch=main&label=markdown)](https://github.com/NishDJ/UNIVERSAL_CATEGORIES/actions/workflows/markdown-validation.yml)
...
[![Stale Issues](https://img.shields.io/github/actions/workflow/status/NishDJ/UNIVERSAL_CATEGORIES/stale.yml?branch=main&label=stale)](https://github.com/NishDJ/UNIVERSAL_CATEGORIES/actions/workflows/stale.yml)
